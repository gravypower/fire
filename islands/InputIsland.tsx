...
export default function InputIsland(
  ...
  const saveLoan = () => {
    if (
      !loanFormData.label || loanFormData.principal === undefined ||
      loanFormData.principal < 0
    ) {
        ...
        <select
          ...
          onChange={(e) =>
            handleFrequencyChange(
              fieldName,
              (e.target as HTMLSelectElement).value as PaymentFrequency,
            )}
    ...
    <div class="slide-in">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
          ...
          {!isAddingLoan && !editingLoanId && parameters.loans &&
            parameters.loans.length > 1 &&
            parameters.loans.some((l) => l.hasOffset) && (
            <div class="mb-4 p-3 bg-green-50 border border-green-200 rounded">
              <div class="flex items-start">
                <svg
                  class="w-4 h-4 text-green-600 mr-2 mt-0.5 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
                ...
                <p class="text-xs text-green-700">
                  <strong>Smart Offset Strategy:</strong>{" "}
                  Leftover cash each period is automatically added to the offset
                  account of your biggest loan with offset enabled. This
            ...
            <div class="border border-gray-300 rounded-lg p-4 bg-gray-50 mb-4 fade-in">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setLoanFormData({
                        ...loanFormData,
                        paymentFrequency: (e.target as HTMLSelectElement)
              ...
              <div class="mb-3 p-3 bg-blue-50 rounded border border-blue-200">
                ...
                <p class="text-xs text-gray-600 mb-2">
                  Leftover cash will be added to this loan's offset to reduce
                  interest
                </p>
              ...
              <div class="mb-3 p-3 bg-green-50 rounded border border-green-200">
                ...
                <p class="text-xs text-gray-600">
                  Interest paid on this loan is tax deductible. Use for
                  investment loans.
                </p>
                {loanFormData.isDebtRecycling && (
                  <div class="mt-2 p-2 bg-yellow-50 border border-yellow-300 rounded fade-in">
                    <p class="text-xs text-yellow-800">
                      ...
                      Only use for loans where borrowed funds are used for
                      income-producing investments. Consult a tax professional.
                    </p>
                  </div>
                )}
              </div>
                      ...
                      >
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs text-gray-600">
                          ...
                          <div>
                            ...
                            <span class="font-medium text-gray-800">
                              ${loan.paymentAmount}/{loan.paymentFrequency}
                            </span>
                          </div>
                          <div>
                            {loan.hasOffset && (
                              <span class="text-blue-600 font-medium">
                                ✓ Offset:
                                ${loan.offsetBalance?.toLocaleString() || 0}
                              </span>
                            )}
                ...
                : (
                  <div class="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                    ...
                    <p class="text-xs text-gray-500">
                      Click "+ Add Loan" above to add a mortgage or other loan
                    </p>
                  </div>
                )}
            </>
