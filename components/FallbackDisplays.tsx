 ...
 */
export function NoMilestonesDisplay(
  { onRetry, context }: FallbackDisplayProps,
) {
  return (
    <div class="card p-6">
      ...
      <div class="text-center py-8">
        ...
        <p class="text-sm text-gray-600 mb-4 max-w-md mx-auto">
          We didn't find any major financial milestones in your simulation
          timeline. This could mean your financial journey is steady, or the
          simulation period may not include significant events like loan payoffs
  ...
  return (
    <div class="card p-6">
      ...
      <div class="text-center py-6">
        ...
        <h4 class="text-lg font-medium text-gray-900 mb-2">
          Milestone Detection Unavailable
        </h4>
        <p class="text-sm text-gray-600 mb-4 max-w-md mx-auto">
          We encountered an issue while analyzing your financial timeline for
          milestones. Your simulation results are still accurate and available.
        </p>
  ...
  return (
    <div class="card p-6">
      ...
      <div class="text-center py-8">
        ...
        <p class="text-sm text-gray-600 mb-4 max-w-md mx-auto">
          We couldn't generate specific retirement recommendations based on your
          current simulation. This might be because your financial plan is
          already well-optimized or the simulation data is insufficient for
          analysis.
        </p>
  ...
  return (
    <div class="card p-6">
      ...
      <div class="text-center py-6">
        ...
        <h4 class="text-lg font-medium text-gray-900 mb-2">
          Advice Generation Unavailable
        </h4>
        <p class="text-sm text-gray-600 mb-4 max-w-md mx-auto">
          We encountered an issue while generating personalized retirement
          recommendations. Your simulation results remain accurate and you can
          still make informed decisions.
        </p>
  ...
  return (
    <div class="card p-6">
      <div class="text-center py-6">
        ...
        <p class="text-sm text-gray-600 mb-4 max-w-md mx-auto">
          We need more {dataType}{" "}
          to provide meaningful analysis. Please ensure your simulation has
          completed successfully and includes sufficient timeline data.
        </p>
...
export function GenericErrorDisplay({
  ...
  const iconPaths = {
    ...
    warning:
      "M12 9v2m0 4h.01M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z",
