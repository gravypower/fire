    ...
    <div class="min-h-screen bg-gray-100 py-8">
      <div class="max-w-6xl mx-auto">
        ...
        <p class="text-center text-gray-600 mb-6">
          This page tests the integration between InputIsland and
          SimulationIsland. Modify parameters on the left to see simulation
          results update automatically on the right.
        </p>
